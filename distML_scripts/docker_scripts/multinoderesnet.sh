...
sshstr=" styagi@"
######nodelist=("v-019 " "v-020 " "v-gpu4 " "v-022 ")
...
iplist=("172.18.0.4" "172.18.0.5" "172.18.0.6" "172.18.0.7")
#change this for cpu allocations in heterogenous mode
cpucoresalloc=("9" "13" "13" "13")
trainsteps=50000
#########batchsizes=("89" "384" "256" "128")
batchsizes=("128" "128" "128" "128")
#####memalloc=("100G" "180G" "120G" "500G")
...
do
	...
	ssh $sshstr${nodelist[$(($i-1))]} "docker run -i -w /resnet-cifar10 -v /home/styagi/prateeks/tensorflow:/resnet-cifar10 -v $log_dir:/root --name $service_id --cpus ${cpucoresalloc[$(($i-1))]} -m ${memalloc[$(($i-1))]} --env TF_CONFIG='$tf_config' --net $network --ip ${iplist[$(($i-1))]} -d tf1ximage:final /bin/bash"
